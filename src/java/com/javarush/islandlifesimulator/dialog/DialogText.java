...
//    TODO надпись отдельно сделать + указать про Энтер - значение по-умочанию
    ...
    public static final String PRINT_TACT_TIME = "Печатать длительность выполнения такта - {0}";
    ...
    public static final String PRINT_TACT_TIME_YES_OR_NO = "Выводить длительность выполнения каждого такта? по-умолчанию Да (0-Нет 1-Да): ";
    ...
    public static final String DURATION_TACT = "Продолжительность {0}-го такта: {1}мс";
}
