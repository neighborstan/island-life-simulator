...
public class DialogText {
    ...
    public static final String ANIMAL_COUNT_ON_LOCATION = "Кол-во животных в каждой локации при старте, не более - {0}";
    ...
    public static final String GO_MESSAGE = "\nПоехали!\n";
    ...
    public static final String INITIAL_NUMBER_OF_ANIMALS = "Начальное кол-во животных в каждой локации, по-умолчанию не более {0} ({1}÷{2}): ";
